<x-app-layout>
    ...
    <div class=" bg-gray-200 dark:bg-gray-900 flex flex-wrap items-center justify-center">
        <div
            class="container max-w-xs lg:max-w-lg bg-white rounded dark:bg-gray-800 shadow-lg transform duration-200 easy-in-out m-12">
            ...
            <div class="">
                <div class="px-7 mb-8">
                    <h2 class="text-3xl font-bold text-green-800 dark:text-gray-300 truncate max-w-sm">
                        {{ __($company->name) }}</h2>
                    <p class="text-gray-400 mt-2 dark:text-gray-400 text-xs truncate max-w-[18rem]"><i
                            class="fa-regular fa-location-pin"></i> {{ __($company->address) }}</p>
                    <div
