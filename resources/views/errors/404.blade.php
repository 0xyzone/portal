                ...
                <div class="absolute">
                    <div class="">
                        ...
                        <p class="my-2 text-gray-300">Sorry about that! Please visit our hompage to get where you need
                            to go.</p>
                        <button
                            class="sm:w-full lg:w-auto my-2 border rounded-md py-4 px-8 text-center bg-emerald-200 text-emerald-800 hover:bg-emerald-300 smooth focus:outline-none focus:ring-2 focus:ring-indigo-700 focus:ring-opacity-50" onclick="location.href='{{ route('home') }}'">Take me there!</button>
                    </div>
                </div>
                <div>
